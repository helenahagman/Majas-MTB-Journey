...
<h2>Bugs</h2>
  ...
  <li>Email entry field accepted all entries - fixed <br> The code was missing the type="email", after adding this the field only accepts emails as entries.</li></ul>
<br>
<h2>Badges</h2>
  <br>
  <ul>
